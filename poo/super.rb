...
class Franquiado < Franquia
    def descricao
        puts super # Invoca classe da classe superior no caso, classe Franquia(Pai)
        "Franquiado"
    end
end
...
class ContaEspecial < Conta
    ...
    def initialize(numero, saldo, limite_especial)
        super(numero, saldo) #initialize da classe pai com parametro, por isso precisou informar o parametro
